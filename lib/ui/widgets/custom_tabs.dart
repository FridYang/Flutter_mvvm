...
class TabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [Tab] ui.widgets.
  ///
  ...
  /// the indicator with the tab's text for [Tab] ui.widgets and all but the
  ...
  /// {@macro flutter.ui.widgets.scrollable.dragStartBehavior}
  final DragStartBehavior dragStartBehavior;

  /// The cursor for a mouse pointer when it enters or is hovering over the
  /// individual tab ui.widgets.
  ///
